...
public class NilexData {
	...
	public String generateAccessToken(String email, String password) throws IOException, InterruptedException {
	...
	public HttpResponse retrieveEntityById(String token, String id) throws IOException, InterruptedException {
	...
	public HttpResponse postEntity(String token, JSONObject article) throws IOException, InterruptedException {
